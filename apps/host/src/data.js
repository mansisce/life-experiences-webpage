...
export const littleHumanLessons = [
...
export const littleHumanRhythms = [
  {
...
export const littleHumanQuestions = [
...
export const interviewQuestions = [
  ...
  "How would I explain stale closures in hooks to another engineer?",
];
