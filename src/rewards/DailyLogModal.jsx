      ...
      <div style={card}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.25rem" }}>
          <div>
            ...
            <p style={{ margin: "0.2rem 0 0", fontSize: "0.82rem", color: "#9ca3af" }}>{goal.title}</p>
          </div>
...
const lbl = { fontSize: "0.8rem", color: "#9ca3af", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.05em" };
...
const toggleBtn = { flex: 1, padding: "0.75rem", borderRadius: "0.5rem", border: "1px solid var(--border, #444)", background: "none", color: "#9ca3af", cursor: "pointer", fontSize: "0.95rem", fontWeight: 600, transition: "all 0.15s" };
...
const closeBtn = { background: "none", border: "none", color: "#9ca3af", fontSize: "1.2rem", cursor: "pointer" };
